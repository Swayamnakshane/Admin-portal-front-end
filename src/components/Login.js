...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { access_token, refresh_token, name, employee_id, is_active } = res.data;
      ...
      <div className="col-12 col-lg-5 d-flex align-items-center justify-content-center p-4" style={{
        ...
        <div className="w-100" style={{ maxWidth: "450px" }}>
          ...
          <div className="text-center mb-5">
            ...
            <h2 className="fw-bold mb-2" style={{ color: "#0d3b66" }}>Trainee Portal</h2>
      ...
      {showBlockModal && (
        <div className="modal fade show d-block" tabIndex="-1" style={{ backgroundColor: "rgba(0,0,0,0.5)" }}>
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content border-0 shadow" style={{ borderRadius: "12px", overflow: "hidden" }}>
              <div className="modal-header border-0" style={{ background: "linear-gradient(135deg, #ff4b4b 0%, #d32f2f 100%)" }}>
                <div className="d-flex align-items-center w-100">
                  <div className="rounded-circle d-flex align-items-center justify-content-center me-3" style={{ 
                    ...
                    <i className="bi bi-slash-circle-fill text-white"></i>
                  </div>
                  <h5 className="modal-title text-white mb-0">Account Deactivated</h5>
                </div>
                <button 
                  type="button" 
              ...
              <div className="modal-body py-4">
                <div className="text-center mb-4">
                  <div className="rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3" style={{ 
                    ...
                    <i className="bi bi-person-x-fill fs-1" style={{ color: "#d32f2f" }}></i>
                  </div>
                  <h4 className="fw-bold mb-2" style={{ color: "#d32f2f" }}>Access Restricted</h4>
                ...
                <div className="alert alert-warning border-0" style={{ background: "rgba(255, 193, 7, 0.1)" }}>
                  <div className="d-flex">
                    <i className="bi bi-info-circle-fill me-2" style={{ color: "#ff9800" }}></i>
                    <div>
                      <h6 className="alert-heading mb-1" style={{ color: "#ff9800" }}>Please Contact Support</h6>
                      <p className="small mb-0" style={{ color: "#616161" }}>
                        For assistance with account reactivation, please contact your system administrator or HR department.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="d-flex mt-4">
                  ...
                  <button 
                    ...
                    onClick={() => openExternalLink("mailto:support@arcapcompany.com")}
                  >

...
//   Spinner, Badge, Modal, Dropdown 
// } from 'react-bootstrap';
// import { 
//   FaUpload, FaTrash, FaSearch, FaFilePdf, 
//   FaFileWord, FaFileImage, FaFileExcel, 
...
//           ...doc,
//           status: doc.verification_status, // Map verification_status to status
//           upload_date: doc.uploaded_at      // Map uploaded_at to upload_date
//         }));
...
//                     <Form.Label className="fw-medium text-muted">Bank Name</Form.Label>
//                     <Form.Control
//                       type="text"
...
//                     <Col md={6}>
//                       <Form.Group className="mb-3">
//                         <Form.Label className="fw-medium text-muted">Account Number</Form.Label>
//                         <Form.Control
//                           type="text"
...
//                     <Col md={6}>
//                       <Form.Group className="mb-3">
//                         <Form.Label className="fw-medium text-muted">IFSC Code</Form.Label>
//                         <Form.Control
//                           type="text"
